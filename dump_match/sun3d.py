...
parser.add_argument('--desc_name', type=str, default='super-2000',
...
if __name__ == "__main__":
    ...
    sun3d_tr_te = Dataset(config.raw_data_path + 'sun3d_train/', config.dump_dir,'sun3d-' + config.desc_name + '-knowntest.hdf5', \
